...
public class EmployerDAO implements InterfaceDAO<Employer> {
    ...
    public void create(Employer entity) throws MyException {
        ...
        try (Connection connection = Service.getConnection()) {
            ...
            throw new MyException("class EmployerDAO method create(Employer entity)", e);
        }
    }
    ...
    @Override
    public Employer read(int id) throws MyException {
        ...
        try(Connection connection = Service.getConnection()){
            ...
            throw new MyException("class EmployerDAO method read(int id)", e);
        }
